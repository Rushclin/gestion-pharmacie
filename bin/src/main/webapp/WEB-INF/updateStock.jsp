					...
					<div class="col-lg-4">
						<div class="page-header-breadcrumb">
							<ul class=" breadcrumb breadcrumb-title">
								...
								<li class="breadcrumb-item"><a href="#!">Mise a jour du stock</a></li>
							</ul>
						</div>
					</div>
				</div>
                                        ...
                                        <div class="card-block">
											...
											<form>
												<div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Quantite <c:out value="${stock.quantiteStock }"/> </label>
                                                     <div class="col-sm-10">
                                                          <input required type="number" name="quantiteStock" class="form-control" value="<c:out value="${stock.quantiteStock }"/>">
                                                     </div>
                                                </div>
